...
public class ArrayListVsLinkedListDemo {
    ...
    private static void demonstrateGrowthMechanism() {
        ...
        System.out.println(
            " 3. 扩容策略：grow(oldCapacity + (oldCapacity >> 1))"
        );
        System.out.println(
            "    即：新容量 = 旧容量 + 旧容量/2 = 旧容量的 1.5倍"
        );
        System.out.println(
            " 4. 扩容操作：Arrays.copyOf(elementData, newCapacity)"
        );
    ...
    private static int getArrayListCapacity(ArrayList<?> list) {
        try {
            java.lang.reflect.Field field = ArrayList.class.getDeclaredField(
                "elementData"
            );
    ...
    private static void demonstrateAccessPerformance() {
        ...
        System.out.println(
            "顺序访问：两者都是 O(n)，ArrayList 略快（数组连续，CPU缓存友好）"
        );
        System.out.println(
    ...
    private static void demonstrateModifyPerformance() {
        ...
        System.out.println(
            "ArrayList 尾部插入: " + arrayListTailInsert + " ms"
        );
        ...
        System.out.println(
            "LinkedList 尾部插入: " + linkedListTailInsert + " ms"
        );
        ...
        System.out.println(
            "ArrayList 中部插入: " + arrayListMiddleInsert + " ms"
        );
        System.out.println(
            "LinkedList 中部插入: " + linkedListMiddleInsert + " ms"
        );

        System.out.println("\n【结论】");
        System.out.println("头部插入：LinkedList 远快于 ArrayList");
        System.out.println(
            "尾部插入：两者差不多，ArrayList 略快（可能触发扩容）"
        );
        System.out.println(
            "中部插入：两者都是 O(n)，ArrayList 略快（CPU缓存友好）"
        );
        System.out.println();
    }
    ...
    private static void demonstrateMemoryUsage() {
        ...
        System.out.println(
            " 内存 = 对象头 + size字段 + elementData引用 + 数组内存"
        );
    ...
    private static void demonstrateIteratorPerformance() {
        ...
        System.out.println(
            "\nArrayList for循环遍历: " + arrayListForLoop + " ms (推荐)"
        );
        ...
        System.out.println(
            "ArrayList for-each遍历: " + arrayListForEach + " ms"
        );
        ...
        System.out.println(
            "\nLinkedList 迭代器遍历: " + linkedListIterator + " ms (推荐)"
        );
        ...
        System.out.println(
            "LinkedList：必须使用迭代器或for-each（编译成迭代器）"
        );
